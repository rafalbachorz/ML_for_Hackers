...
spam2.path <- file.path("E:\\VisualStudioRepos\\ML_for_Hackers\\03-Classification\\data", "spam_2")
easyham.path <- file.path("E:\\VisualStudioRepos\\ML_for_Hackers\\03-Classification\\data", "easy_ham")
easyham2.path <- file.path("E:\\VisualStudioRepos\\ML_for_Hackers\\03-Classification\\data", "easy_ham_2")
hardham.path <- file.path("E:\\VisualStudioRepos\\ML_for_Hackers\\03-Classification\\data", "hard_ham")
hardham2.path <- file.path("E:\\VisualStudioRepos\\ML_for_Hackers\\03-Classification\\data", "hard_ham_2")
...
qplot(x = seq(0, nrow(data.frame(y1))), y = data.frame(y1)[, 1], aes = ())
...
ggsave(plot = ex1,
       filename = file.path("E:\\VisualStudioRepos\\ML_for_Hackers\\03-Classification\\images", "00_Ex1.pdf"),
       height = 10,
       width = 10)
